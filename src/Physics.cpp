...
// void
// Phys::updateEntity(Entity &p, const Map& map)
// {    
...
// void
// Phys::checkCollisionX(Entity& p, const Map& map)
// {
//     redo:
...
// void
// Phys::checkCollisionY(Entity& p, const Map& map)
// {
//     const lm::Rect2f& bounding = p.boundingBox();
//     const float x = p.position.x + bounding.pos.x;
//     const float y = p.position.y + bounding.pos.y;
...
// bool
// Phys::checkDamages(Entity& attacker, Entity& target)
// {
