...
SettingsMenu::load()
{
    ...
    _keyBatch.draw(lm::FontProvider::instance().get("roboto80"), "Bind Keys",
                    {SCREEN_WIDTH / 2 - 200.f / 2.f, SCREEN_HEIGHT / 2 - 300.f / 2.f}, {1.f, 0.f, 1.f, _keyAlpha});
    _keyBatch.send();

    _resolutionBatch.draw(lm::FontProvider::instance().get("roboto80"), "Resolution",
                    {SCREEN_WIDTH / 2 - 200.f / 2, SCREEN_HEIGHT / 2 - 100.f / 2}, {1.f, 0.f, 1.f, _resoAlpha});
    ...
    _fullscreenBatch.draw(lm::FontProvider::instance().get("roboto80"), "Fullscreen",
                    {SCREEN_WIDTH / 2 + 220.f / 2, SCREEN_HEIGHT / 2 + 300.f / 2}, {1.f, 0.f, 1.f, _fullscreenAlpha});
...
SettingsMenu::update()
{
    ...
    _keyBatch.flush();
    _keyBatch.draw(lm::FontProvider::instance().get("roboto80"), "Bind Keys",
                    {SCREEN_WIDTH / 2 - 200.f / 2, SCREEN_HEIGHT / 2 - 300.f / 2}, {1.f, 0.f, 1.f, _keyAlpha});
    _keyBatch.send();
    ...
    _fullscreenBatch.draw(lm::FontProvider::instance().get("roboto80"), "Fullscreen",
                    {SCREEN_WIDTH / 2 - 220.f / 2, SCREEN_HEIGHT / 2 + 300.f / 2}, {1.0, fsGreen, fsBlue, _fullscreenAlpha});
    _fullscreenBatch.send();
